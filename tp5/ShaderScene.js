...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders[6].setUniformsValues({ amplitude: this.amplitude });
	...
	onAmplitudeFactorChanged(v) {
		this.testShaders[this.selectedExampleShader].setUniformsValues({ amplitude: this.amplitudeFactor });
	}
